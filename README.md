...
<!-- Fernanda Melendez Brooklyn Walker Jack E Singley Academy-->
...
<div class="mySlides fade">
  ...
  <img src="https://media2.giphy.com/media/3waZ5iXDUi3mxRchCg/giphy.gif?cid=790b761168bfd698336ace068f5d606cc7971f93512075dd&rid=giphy.gif&ct=g" style="width:100%; height: 500px;">
   <div class="text" style="font-size: 60px; color: white; font-family: 'Antonio';" ></div>
</div>

<div class="mySlides fade">
  <div class="numbertext">2 / 3</div>
  <img src="https://media1.giphy.com/media/ev6f01yYm5SbAIkVNV/giphy.gif?cid=790b761105c0c0557eaecfa42391859d7a9be78b4dc22161&rid=giphy.gif&ct=g" style="width:100%; height: 500px">
  <div class="text" style="font-size: 60px; color: white; font-family: 'Antonio';" ><b>2D</b></div>
</div>

<div class="mySlides fade">
  <div class="numbertext">3 / 3</div>
  <img src="https://media0.giphy.com/media/yH94mr5YhUUy0uxiiT/giphy.gif?cid=790b7611c5313591221702e3c04143c33ea14e76454aad9d&rid=giphy.gif&ct=g" style="width:100%; height: 500px">
  <div class="text" style="font-size: 60px; color: white; font-family: 'Antonio';" ><b>3D</b></div>
</div>
...
<!--THIS IS 2D-->
<div class="w3-black">
  <h1 class="center" id="2D" style="font-family: 'Antonio';text-align: center;  margin-top: 150px; width: 1000px; margin-bottom: 100px;" >Early Entry 2D</h1>
</div>
    <div >
      <br><br>

      <img class="animation" class="animation" src="https://i.imgur.com/WsKHqKS.gif" >
      <img  class="ani2" src="https://i.imgur.com/PdL9Lmw.gif">

      <br><br>

       <button class="animatorName1 ">Animator: BurgerGuy</button>
       <button class="animatorName2" style="margin-bottom: 100px;">Animator: PlayRat</button>


      <img  class="animation" src="https://i.imgur.com/BBuiB3X.gif">
...
<div style="margin-left: 44%;">
    ...
    <button style="style2d " class="w3-hover-red but2d">2D</button>
